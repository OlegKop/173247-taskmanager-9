...
renderComponent(main.querySelector(`.board`), getCardEdit());

for (let i = 0; i < CARDS_COUNT; i++) {
  renderComponent(main.querySelector(`.board__tasks`), getCardForm());
}

renderComponent(main.querySelector(`.board`), getButton());